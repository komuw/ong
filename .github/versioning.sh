...
create_tag() {
    ...
    printf "\n with commit message, see Changelong: https://github.com/komuw/ong/blob/main/CHANGELOG.md \n" && \
    git tag -a "${VERSION}" -m "see Changelong: https://github.com/komuw/ong/blob/main/CHANGELOG.md"
