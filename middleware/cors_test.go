...
func TestCorsPreflight(t *testing.T) {
	...
	t.Run("preflight success", func(t *testing.T) {
		...
		msg := "hello"
		wrappedHandler := cors(someCorsHandler(msg), nil, nil, nil, DefaultCorsCacheDuration)
	...
	t.Run("appropriate headers set", func(t *testing.T) {
		...
		msg := "hello"
		wrappedHandler := cors(someCorsHandler(msg), []string{"*"}, []string{"*"}, []string{"*"}, DefaultCorsCacheDuration)
		rec := httptest.NewRecorder()
		req := httptest.NewRequest(http.MethodOptions, "/someUri", nil)
	...
	t.Run("origin", func(t *testing.T) {
		...
		for _, tt := range tests {
			...
			t.Run(tt.name, func(t *testing.T) {
				...
				msg := "hello"
				wrappedHandler := cors(someCorsHandler(msg), tt.allowedOrigins, []string{"*"}, []string{"*"}, DefaultCorsCacheDuration)
				rec := httptest.NewRecorder()
				req := httptest.NewRequest(http.MethodOptions, "/someUri", nil)
				req.Header.Add(acrmHeader, "is-set") // preflight request header set
	...
	t.Run("method", func(t *testing.T) {
		...
		for _, tt := range tests {
			...
			t.Run(tt.name, func(t *testing.T) {
				...
				wrappedHandler := cors(someCorsHandler(msg), []string{"*"}, tt.allowedMethods, []string{"*"}, DefaultCorsCacheDuration)
				rec := httptest.NewRecorder()
				req := httptest.NewRequest(http.MethodOptions, "/someUri", nil)
	...
	t.Run("header", func(t *testing.T) {
		...
		for _, tt := range tests {
			...
			t.Run(tt.name, func(t *testing.T) {
				...
				msg := "hello"
				wrappedHandler := cors(someCorsHandler(msg), []string{"*"}, []string{"*"}, tt.allowedHeaders, DefaultCorsCacheDuration)
				rec := httptest.NewRecorder()
				req := httptest.NewRequest(http.MethodOptions, "/someUri", nil)
				req.Header.Add(acrmHeader, "is-set") // preflight request header set
				req.Header.Add(originHeader, "http://some-origin.com")
